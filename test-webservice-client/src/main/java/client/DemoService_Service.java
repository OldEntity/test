 ...
 * 
 */
@WebServiceClient(name = "DemoService", targetNamespace = "http://server.testwebserviceserver.lishuo.com", wsdlLocation = "http://localhost:8888/demo/api?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DEMOSERVICE_QNAME = new QName("http://server.testwebserviceserver.lishuo.com", "DemoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/demo/api?wsdl");
    ...
    public DemoService getDemoServiceImplPort() {
        return super.getPort(new QName("http://server.testwebserviceserver.lishuo.com", "DemoServiceImplPort"), DemoService.class);
    }
    ...
    public DemoService getDemoServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.testwebserviceserver.lishuo.com", "DemoServiceImplPort"), DemoService.class, features);
    }
